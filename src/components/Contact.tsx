...
import ShapeTwelve from "@/images/shape-12.svg";
import ShpaeThirteen from "@/images/shape-13.svg";

const Contact: React.FC = () => {
  return (
    <section id="support" className="i pg fh rm ji gp uq">
      <Image src={ShapeSix} alt="Shape" className="h aa y" />
      <Image src={ShapeThree} alt="Shape" className="h ca u" />
      <Image src={ShapeSeven} alt="Shape" className="h w da ee" />
      <Image src={ShapeTwelve} alt="Shape" className="h p s" />
      <Image src={ShpaeThirteen} alt="Shape" className="h r q" />
      ...
      <div className="i va bb ye ki xn wq jb mo">
        <div className="tc uf sn tf rn un zf xl:gap-10">
          <div className="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
            <Image src={ShapeThree} alt="Shape" className="h la x wd" />
            <Image src={ShapeSix} alt="Shape" className="h la ma ne kf" />
            <div className="fb">
          ...
          <div className="animate_top w-full nn/5 vo/3 vk sg hh sm yh tq">
            <form>
              ...
              <div className="tc xf">
                <button type="submit" className="vc rg lk gh ml il hi gi _l">
                  Send Message
                </button>
              </div>
            </form>
